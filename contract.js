...
// create a RPC (remote procedure call) to connect to an ethereum node
const rpcURL = "https://ropsten.infura.io/v3/" + infuraToken;

// instantiate web3 using  this URL
const web3 = new Web3(rpcURL);

console.log("connected to web3");

// the ABI (interface) for our contract
const abi = [
	{
		"inputs": [
			{
...
// specify the created contract address 
...
// specify the owner address
const owner = ownerAddress;

// run the methods in the contract (using javascript)
